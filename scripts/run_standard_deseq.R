run_standard_deseq = function(folder_of_featurecounts, 
    ...
    create_feature_path = "scripts/feature_count/create_feature_count_table.R"
    make_deseq_path = "scripts/feature_count/make_deseq_dfs.R"
    ...
    # this function creates a table with the first column being Geneid, then each
    ...
    #the prefix is something which it appended by feature counts and the suffix
    ...
    colnames(timecourse_feature) = c("Geneid", 
                                     "DOX_a_0.0125_1", "DOX_a_0.0125_2", "DOX_a_0.0125_3",
                                     "DOX_b_0.0187_1", "DOX_b_0.0187_2", "DOX_b_0.0187_3",
                                     "DOX_c_0.021_1", "DOX_c_0.021_2", "DOX_c_0.021_3", 
                                     "DOX_f_0.025_1", "DOX_f_0.025_2", "DOX_f_0.025_3", 
                                     "DOX_h_0.075_1", "DOX_h_0.075_2", "DOX_h_0.075_3",
                                     "NT_abcfh_0_1", "NT_abcfh_0_2", "NT_abcfh_0_3", 
                                     "gene_name")
    ...
    #it can mess up the way DESeq2 normalizes counts and give you funky p-values
