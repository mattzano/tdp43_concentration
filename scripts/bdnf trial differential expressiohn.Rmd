...
featureCounts <- create_feature_count_table("/Users/matteozanovello/Documents/phd/research_lines/tdp43_concentration/data/feature_counts") #change here!!
...
my.dds <- run_standard_deseq("/Users/matteozanovello/Documents/phd/research_lines/tdp43_concentration/data/feature_counts", 
                             base_grep = "NT",
                             contrast_grep = "DOX",  
                             grep_pattern = "",
                             baseName = "Untreated",
...
input_splicing <- separate_rows(ControlControl_ControlTDP43KD, c(mean_dpsi_per_lsv_junction, probability_changing, 
